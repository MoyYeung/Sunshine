package com.example.moyyang.sunshine.app;
...
import com.example.moyyang.sunshine.MainActivityFragment;
import com.example.moyyang.sunshine.R;


/**
 * Created by moy.yang on 3/29/2016.
 */
    ...
    public View newView(Context context, Cursor cursor, ViewGroup parent) {
        ...
        switch (viewType){
            case VIEW_TYPE_TODAY:{
                layloutId =R.layout.list_item_forecast_today;
                break;
            }
            case VIEW_TYPE_FUTURE_DAY:{
                layloutId =R.layout.list_item_forecast;
                break;
            }
        }


        View view = LayoutInflater.from(context).inflate(layloutId, parent, false);
