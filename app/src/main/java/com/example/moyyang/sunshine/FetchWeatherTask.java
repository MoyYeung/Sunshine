...
public class FetchWeatherTask extends AsyncTask<String, Void, Void> {
    ...
    private void getWeatherDataFromJson(String forecastJsonStr, String locationSetting)
        ...
        try {
            ...
            String unitType = pref.getString(mContext.getString(R.string.pref_units_key), mContext.getString(R.string.pref_units_metric));
    ...
    protected Void doInBackground(String... params) {
        ...
        String units = "metric";
        int numDays = 14;
        String appId = "33cccb97455e6689bbefac2ed29855ae";
